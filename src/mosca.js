...
class MqttBackend {
  ...
  _setMoscaCallbacks() {
    ...
    this.server.authorizePublish = (client, topic, payload, callback) => {
      this._checkAuthorization(client, topic, "attrs", payload, callback);
    };
    this.server.authorizeSubscribe = (client, topic, payload, callback) => {
      this._checkAuthorization(client, topic, "config", payload, callback);
    };
   ...
   * made
   */
  _checkAuthorization(client, topic, tag, payload, callback) {
